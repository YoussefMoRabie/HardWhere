    ...
    <div className="footer">
      <div className="head">
        ...
        <div className="contact">
          ...
          <ul>
            <li><Link to=""><FacebookIcon color='action' fontSize='large'></FacebookIcon></Link></li>
            <li><Link to=""><TwitterIcon color='action' fontSize='large'></TwitterIcon></Link></li>
            <li><Link to=""><InstagramIcon color='action' fontSize='large'></InstagramIcon></Link></li>
            <li><Link to=""><GoogleIcon color='action' fontSize='large'></GoogleIcon></Link></li>
          </ul>
        </div>
      </div>
      <div className="tail">
