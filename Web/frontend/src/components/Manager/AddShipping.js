...
const handleTimeChange= (event) => {
  ...
  return (
    <div className='addA'>
      <h3><span>Add Shipping Company</span></h3>
      <form action="" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', gap: '15px' }} className='AddSupp'>
        <TextField id="outlined-basic" onChange={handleNameChange} sx={{ width: '300px' }} required label="Company Name" variant="outlined" />
        <FormControl>
        ...
        <button className='addP' disabled={err} type='submit' onClick={handleSubmit}> Add Company</button>
